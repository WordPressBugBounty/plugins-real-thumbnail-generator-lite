...
namespace DevOwl\RealThumbnailGenerator\Vendor\MatthiasWeb\Utils;

use DevOwl\RealThumbnailGenerator\Vendor\ColinODell\Json5\Json5Decoder;
use DevOwl\RealThumbnailGenerator\Vendor\ColinODell\Json5\SyntaxError;
use JsonException;
...
class FixInvalidJsonInDb
{
    ...
    public function ensureValidJsonString($val)
    {
        ...
        if (\function_exists('DevOwl\\RealThumbnailGenerator\\Vendor\\json_validate')) {
