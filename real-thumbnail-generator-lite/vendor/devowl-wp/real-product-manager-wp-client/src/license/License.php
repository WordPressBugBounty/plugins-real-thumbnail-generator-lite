...
namespace DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\license;

use DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\client\ClientUtils;
...
use DevOwl\RealThumbnailGenerator\Vendor\DevOwl\RealProductManagerWpClient\Utils;
...
class License
{
     ...
     *
     * @see https://regex101.com/r/OxkZVE/3
     */
    const VALIDATE_NEW_HOSTNAME_SKIP_BY_REGEXP = '/^(?:\\w+-\\d+-\\d+-\\d+-\\d+\\.[^\\.]+\\.(?:[\\w-]+[-.])?amazonaws\\.com|.*temp\\.domains|\\w+-\\w+\\.[^\\.]+\\.azurewebsites\\.net)$/m';
